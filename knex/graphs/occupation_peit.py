...
def extract_occupation_peit(doc: Doc) -> None:
    ...
    for occupation_span in occupations_spans:
        ...
        pk_paial = graph.create_entity(classes.C11_appellationInALanguage, text=occupation_span.text)
        graph.add_triple(pk_paial, properties.P11_isAppellationForLanguageOf, pk_occupation)
